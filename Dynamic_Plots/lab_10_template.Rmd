...
# the narrower the ellipse, the darker the color, the stronger the correlation
...
# geom_ribbon is recommended when there is non-linear variable
...
solar_tidy$date <- hms(solar_tidy$time) 
...
aq_plot
animate(aq_plot, nframes = 24, renderer =
          gifski_renderer("aq_animate.gif"))
```
